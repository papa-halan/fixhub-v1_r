...
Canonical implementation note: this file mirrors [`docs/spec/core.md`](/C:/Users/halan/PycharmProjects/fixhub-v1/docs/spec/core.md) so repo-level automation prompts can read a stable `spec/core.md` path.
