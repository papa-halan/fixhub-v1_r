...
from app.services import AuthenticationError, authenticate_user, is_demo_user_email
...
def switch_user(
    ...
    if not request.app.state.settings.demo_mode or not is_demo_user_email(email):
